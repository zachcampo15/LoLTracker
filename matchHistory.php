...
<html lang="en">
  ...
  <body>
    ...
    <?php
if(($resultData['MatchHistories']['queueId'] == '400') || ($resultData['MatchHistories']['queueId'] == '100') || ($resultData['MatchHistories']['queueId'] == '420') || ($resultData['MatchHistories']['queueId'] == '430') || ($resultData['MatchHistories']['queueId'] == '440') || ($resultData['MatchHistories']['queueId'] == '450') || ($resultData['MatchHistories']['queueId'] == '830') || ($resultData['MatchHistories']['queueId'] == '840') || ($resultData['MatchHistories']['queueId'] == '850')){

    
    ?>
    <br>
    <h2>MOST RECENT MATCH HISTORY</h2>
    <br>

    
    <?php
    $gameDuration = $resultData['MatchHistories']['gameDuration'];
    ...
    for($r = 0; $r<5;$r++){
        $kills = $resultData['MatchHistories']['participants'][$r]['stats']['kills'];
        $assists = $resultData['MatchHistories']['participants'][$r]['stats']['assists'];
        $deaths = $resultData['MatchHistories']['participants'][$r]['stats']['deaths'];
    ...
    $participants = array();
    for($x=0; $x<10; $x++){
        #print_r($resultData['MatchHistories']['participantIdentities'][$x]);
        $participants[$x] = $resultData['MatchHistories']['participantIdentities'][$x]['player']['summonerName'];
        ?>
    ...
    $win = $resultData['MatchHistories']['teams'][0]['win'];
    if($win == "Fail"){
        ?>
        <div class="container">
            <div class="row">
    ...
    <?php
    $firstDragon = $resultData['MatchHistories']['teams'][0]['firstDragon'];
    
    $baronKills = $resultData['MatchHistories']['teams'][0]['baronKills'];
    $riftHeraldKills = $resultData['MatchHistories']['teams'][0]['riftHeraldKills'];
    $firstBlood = $resultData['MatchHistories']['teams'][0]['firstBlood'];
    $firstTower = $resultData['MatchHistories']['teams'][0]['firstTower'];
    $inhibitorKills = $resultData['MatchHistories']['teams'][0]['inhibitorKills'];
    $towerKills = $resultData['MatchHistories']['teams'][0]['towerKills'];
    $dragonKills = $resultData['MatchHistories']['teams'][0]['dragonKills'];
    ...
    for($y=0; $y<5; $y++){
        ...
        <?php
        $champLevels = $resultData['MatchHistories']['participants'][$y]['stats']['champLevel'];
        $championHelper = $resultData['MatchHistories']['participants'][$y]['championId'];
    ...
    <?php
        ...
        #TIMELINE
        $csPerMinDiffInLane = $resultData['MatchHistories']['participants'][$y]['timeline']['csDiffPerMinDeltas']['10-20'];
        $goldPerMinDeltas = $resultData['MatchHistories']['participants'][$y]['timeline']['goldPerMinDeltas']['10-20'];
        $lanes = $resultData['MatchHistories']['participants'][$y]['timeline']['lane'];

        #PERSONAL STATS
        $kills = $resultData['MatchHistories']['participants'][$y]['stats']['kills'];
        $assists = $resultData['MatchHistories']['participants'][$y]['stats']['assists'];
        $deaths = $resultData['MatchHistories']['participants'][$y]['stats']['deaths'];
        $doubleKills = $resultData['MatchHistories']['participants'][$y]['stats']['doubleKills'];
        $tripleKills = $resultData['MatchHistories']['participants'][$y]['stats']['tripleKills'];
        $quadraKills = $resultData['MatchHistories']['participants'][$y]['stats']['quadraKills'];
        $pentaKills = $resultData['MatchHistories']['participants'][$y]['stats']['pentaKills'];
        $totalMinionKills = $resultData['MatchHistories']['participants'][$y]['stats']['totalMinionsKilled'];
        $neutralMinionsKilled = $resultData['MatchHistories']['participants'][$y]['stats']['neutralMinionsKilled'];
        $totalCS = $totalMinionKills + $neutralMinionsKilled;
        $CSperMin = $totalCS/$mins;
        $CSperMin = round($CSperMin,2);
        $visionScore = $resultData['MatchHistories']['participants'][$y]['stats']['visionScore'];
        $turretPERSONALKills = $resultData['MatchHistories']['participants'][$y]['stats']['turretKills'];
        $inhibitorPERSONALKills = $resultData['MatchHistories']['participants'][$y]['stats']['inhibitorKills'];


        $firstBloodKill = $resultData['MatchHistories']['participants'][$y]['stats']['firstBloodKill'];
        $largestKillingSpree = $resultData['MatchHistories']['participants'][$y]['stats']['largestKillingSpree'];
...
for($y=5; $y<10; $y++){
    ...
    $win = $resultData['MatchHistories']['teams'][1]['win'];
    if($win == "Fail"){
        ?>
        <div class="col-md-6" style="background:#F08080;">
        <?php
...
<div class="col-md-6">
    ...
    $firstDragon = $resultData['MatchHistories']['teams'][1]['firstDragon'];
    
    $baronKills = $resultData['MatchHistories']['teams'][1]['baronKills'];
    $riftHeraldKills = $resultData['MatchHistories']['teams'][1]['riftHeraldKills'];
    $firstBlood = $resultData['MatchHistories']['teams'][1]['firstBlood'];
    $firstTower = $resultData['MatchHistories']['teams'][1]['firstTower'];
    $inhibitorKills = $resultData['MatchHistories']['teams'][1]['inhibitorKills'];
    $towerKills = $resultData['MatchHistories']['teams'][1]['towerKills'];
    $dragonKills = $resultData['MatchHistories']['teams'][1]['dragonKills'];
    if($firstDragon == NULL){
        $firstDragonAnswer = "NO";
    }
    if($firstDragon == '1'){
    ...
    <?php
        ...
        #print_r($resultData['MatchHistories']['participants'][$y]['stats']);
    }
