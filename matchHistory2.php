...
<html lang="en">
  ...
  <body>
    ...
    <?php
if(($resultData['MatchHistories2']['queueId'] == '400') || ($resultData['MatchHistories2']['queueId'] == '100') || ($resultData['MatchHistories2']['queueId'] == '420') || ($resultData['MatchHistories2']['queueId'] == '430') || ($resultData['MatchHistories2']['queueId'] == '440') || ($resultData['MatchHistories2']['queueId'] == '450') || ($resultData['MatchHistories2']['queueId'] == '830') || ($resultData['MatchHistories2']['queueId'] == '840') || ($resultData['MatchHistories2']['queueId'] == '850')){

    
    ?>
    <br>
    <h2>2nd MOST RECENT MATCH HISTORY</h2>
    <br>

    
    <?php
    $gameDuration = $resultData['MatchHistories2']['gameDuration'];
    ...
    for($r = 0; $r<5;$r++){
        $kills = $resultData['MatchHistories2']['participants'][$r]['stats']['kills'];
        $assists = $resultData['MatchHistories2']['participants'][$r]['stats']['assists'];
        $deaths = $resultData['MatchHistories2']['participants'][$r]['stats']['deaths'];
    ...
    $participants = array();
    for($x=0; $x<10; $x++){
        #print_r($resultData['MatchHistories2']['participantIdentities'][$x]);
        $participants[$x] = $resultData['MatchHistories2']['participantIdentities'][$x]['player']['summonerName'];
        ?>
    ...
    $win = $resultData['MatchHistories2']['teams'][0]['win'];
    if($win == "Fail"){
        ?>
        <div class="container">
            <div class="row">
    ...
    <?php
    $firstDragon = $resultData['MatchHistories2']['teams'][0]['firstDragon'];
    
    $baronKills = $resultData['MatchHistories2']['teams'][0]['baronKills'];
    $riftHeraldKills = $resultData['MatchHistories2']['teams'][0]['riftHeraldKills'];
    $firstBlood = $resultData['MatchHistories2']['teams'][0]['firstBlood'];
    $firstTower = $resultData['MatchHistories2']['teams'][0]['firstTower'];
    $inhibitorKills = $resultData['MatchHistories2']['teams'][0]['inhibitorKills'];
    $towerKills = $resultData['MatchHistories2']['teams'][0]['towerKills'];
    $dragonKills = $resultData['MatchHistories2']['teams'][0]['dragonKills'];
    ...
    for($y=0; $y<5; $y++){
        ...
        <?php
        $champLevels = $resultData['MatchHistories2']['participants'][$y]['stats']['champLevel'];
        $championHelper = $resultData['MatchHistories2']['participants'][$y]['championId'];
    ...
    <?php
        ...
        #TIMELINE
        $csPerMinDiffInLane = $resultData['MatchHistories2']['participants'][$y]['timeline']['csDiffPerMinDeltas']['10-20'];
        $goldPerMinDeltas = $resultData['MatchHistories2']['participants'][$y]['timeline']['goldPerMinDeltas']['10-20'];
        $lanes = $resultData['MatchHistories2']['participants'][$y]['timeline']['lane'];

        #PERSONAL STATS
        $kills = $resultData['MatchHistories2']['participants'][$y]['stats']['kills'];
        $assists = $resultData['MatchHistories2']['participants'][$y]['stats']['assists'];
        $deaths = $resultData['MatchHistories2']['participants'][$y]['stats']['deaths'];
        $doubleKills = $resultData['MatchHistories2']['participants'][$y]['stats']['doubleKills'];
        $tripleKills = $resultData['MatchHistories2']['participants'][$y]['stats']['tripleKills'];
        $quadraKills = $resultData['MatchHistories2']['participants'][$y]['stats']['quadraKills'];
        $pentaKills = $resultData['MatchHistories2']['participants'][$y]['stats']['pentaKills'];
        $totalMinionKills = $resultData['MatchHistories2']['participants'][$y]['stats']['totalMinionsKilled'];
        $neutralMinionsKilled = $resultData['MatchHistories2']['participants'][$y]['stats']['neutralMinionsKilled'];
        $totalCS = $totalMinionKills + $neutralMinionsKilled;
        $CSperMin = $totalCS/$mins;
        $CSperMin = round($CSperMin,2);
        $visionScore = $resultData['MatchHistories2']['participants'][$y]['stats']['visionScore'];
        $turretPERSONALKills = $resultData['MatchHistories2']['participants'][$y]['stats']['turretKills'];
        $inhibitorPERSONALKills = $resultData['MatchHistories2']['participants'][$y]['stats']['inhibitorKills'];


        $firstBloodKill = $resultData['MatchHistories2']['participants'][$y]['stats']['firstBloodKill'];
        $largestKillingSpree = $resultData['MatchHistories2']['participants'][$y]['stats']['largestKillingSpree'];
...
for($y=5; $y<10; $y++){
    ...
    $win = $resultData['MatchHistories2']['teams'][1]['win'];
    if($win == "Fail"){
        ?>
        <div class="col-md-6" style="background:#F08080;">
        <?php
...
<div class="col-md-6">
    ...
    $firstDragon = $resultData['MatchHistories2']['teams'][1]['firstDragon'];
    
    $baronKills = $resultData['MatchHistories2']['teams'][1]['baronKills'];
    $riftHeraldKills = $resultData['MatchHistories2']['teams'][1]['riftHeraldKills'];
    $firstBlood = $resultData['MatchHistories2']['teams'][1]['firstBlood'];
    $firstTower = $resultData['MatchHistories2']['teams'][1]['firstTower'];
    $inhibitorKills = $resultData['MatchHistories2']['teams'][1]['inhibitorKills'];
    $towerKills = $resultData['MatchHistories2']['teams'][1]['towerKills'];
    $dragonKills = $resultData['MatchHistories2']['teams'][1]['dragonKills'];
    if($firstDragon == NULL){
        $firstDragonAnswer = "NO";
    }
    if($firstDragon == '1'){
    ...
    <?php
        ...
        #print_r($resultData['MatchHistories2']['participants'][$y]['stats']);
    }
